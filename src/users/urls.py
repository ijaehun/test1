...
urlpatterns = [
    ...
    re_path(r'^tables5_1/$', views.TablesView5_1.as_view(), name="tables5_1_url"),
    re_path(r'^tables5_1_results/$', views.TablesView5_1_results.as_view(), name="tables5_1_results_url"),
    ...
    re_path(r'^tables9_1/$', views.TablesView9_1.as_view(), name="tables9_1_url"),
    re_path(r'^tables9_2/$', views.TablesView9_2.as_view(), name="tables9_2_url"),
    re_path(r'^tables9_3/$', views.TablesView9_3.as_view(), name="tables9_3_url"),
    re_path(r'^tables9_4/$', views.TablesView9_4.as_view(), name="tables9_4_url"),
    re_path(r'^tables9_5/$', views.TablesView9_5.as_view(), name="tables9_5_url"),
    ...
    re_path(r'^tables12_1/$', views.TablesView12_1.as_view(), name="tables12_1_url"),
    re_path(r'^tables12_2/$', views.TablesView12_2.as_view(), name="tables12_2_url"),
    ...
    re_path(r'^tables15_1/$', views.TablesView15_1.as_view(), name="tables15_1_url"),
    re_path(r'^tables15_2/$', views.TablesView15_2.as_view(), name="tables15_2_url"),
    ...
    re_path(r'^tables18_1/$', views.TablesView18_1.as_view(), name="tables18_1_url"),
    re_path(r'^tables18_2/$', views.TablesView18_2.as_view(), name="tables18_2_url"),
    re_path(r'^tables18_3/$', views.TablesView18_3.as_view(), name="tables18_3_url"),
    re_path(r'^tables18_4/$', views.TablesView18_4.as_view(), name="tables18_4_url"),
    re_path(r'^tables18_5/$', views.TablesView18_5.as_view(), name="tables18_5_url"),
    ...
    re_path(r'^tables21_1/$', views.TablesView21_1.as_view(), name="tables21_1_url"),
    re_path(r'^tables21_2/$', views.TablesView21_2.as_view(), name="tables21_2_url"),
    ...
    re_path(r'^tables24_1/$', views.TablesView24_1.as_view(), name="tables24_1_url"),
    re_path(r'^tables24_2/$', views.TablesView24_2.as_view(), name="tables24_2_url"),
